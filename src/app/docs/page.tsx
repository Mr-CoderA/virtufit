        ...
        <article className="space-y-12">
          ...
          <section>
            ...
            <p className="mt-2 text-[14px] text-[#A09E97]">
              All endpoints are relative to this base. For local development use your app origin (e.g. <code className="rounded bg-[#2C2C27] px-1.5 py-0.5 text-[13px] text-[#A09E97]">http://localhost:3000</code>).
            </p>
          </section>
              ...
              <table className="w-full min-w-[480px] text-left text-[14px]">
                ...
                <tbody className="text-[#A09E97]">
                  ...
                  <tr className="border-b border-[rgba(240,239,232,0.08)]" style={{ borderWidth: '0.5px' }}>
                    ...
                    <td className="py-3 pl-4">String</td>
                    <td className="py-3 pl-4">No</td>
                    <td className="py-3 pl-4">URL to POST completion payload (fire-and-forget).</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
{`{
  ...
  "processing_time_ms": 12000
            ...
            <ul className="mt-1 text-[14px] text-[#A09E97] space-y-1">
              <li><code className="rounded bg-[#2C2C27] px-1 text-[#A09E97]">success</code> — true on success</li>
...
$data = json_decode($response, true);`}
          ...
          <section>
            ...
            <p className="mb-4 text-[15px] leading-[1.75] text-[#A09E97]">
              If you pass <code className="rounded bg-[#2C2C27] px-1.5 py-0.5 text-[13px] text-[#A09E97]">webhook_url</code>, we send a POST request with JSON when generation completes. The request is fire-and-forget (we do not retry on failure).
            </p>
            <p className="mb-2 text-[11px] font-medium uppercase tracking-[0.1em] text-[#D9714A]" style={{ fontFamily: 'system-ui, sans-serif' }}>
              Payload
            </p>
